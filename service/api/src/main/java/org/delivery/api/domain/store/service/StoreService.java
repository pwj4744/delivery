...
public class StoreService {
    ...
    public StoreEntity getStoreWithThrow(Long id){
        var entity = storeRepository.findFirstByIdAndStatusOrderByIdDesc(id, StoreStatus.REGISTERED);   //디버깅을 위해 이렇게 풀어쓰기도
    ...
    public StoreEntity register(StoreEntity storeEntity){
        return Optional.ofNullable(storeEntity)     // null일 수 있으니 check
            .map(it ->{
